...
// MedFleet Landing page in React + Bootstrap 5
// - Injects Bootstrap CSS & JS from CDN on mount for convenience
// - Uses the same layout as your HTML version: Navbar → Hero (video) → Feature cards → Team → Contact → Footer
                ...
                <div className="container-lg">
                    ...
                    <div className="collapse navbar-collapse" id="nav">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-3">
                            ...
                            <li className="nav-item ms-lg-2"><a className="btn link-login rounded-pill px-3" href="#">Đăng nhập</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
